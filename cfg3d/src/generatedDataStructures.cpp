...
vector<string> temp;
	...
	appendRuleInstance(learningRules,RulePtr(new SingleRule<CPU,CPUSide_CPUFront>()));
	appendRuleInstance(learningRules,RulePtr(new DoubleRule<CPUSide_CPUFront_CPUTop,CPUSide_CPUFront,CPUTop>()));
	appendRuleInstance(learningRules,RulePtr(new SingleRule<CPU,CPUSide_CPUFront_CPUTop>()));
	appendRuleInstance(learningRules,RulePtr(new DoubleRule<CPUSide_CPUFront_chairBack,CPUSide_CPUFront,chairBack>()));
	appendRuleInstance(learningRules,RulePtr(new SingleRule<CPU,CPUSide_CPUFront_chairBack>()));
	appendRuleInstance(learningRules,RulePtr(new DoubleRule<CPUTop_CPUFront,CPUTop,CPUFront>()));
	appendRuleInstance(learningRules,RulePtr(new SingleRule<CPU,CPUTop_CPUFront>()));
	...
	appendRuleInstance(learningRules,RulePtr(new SingleRule<Chair,chairArmRest_chairBackRest_chairBack>()));
	...
	appendRuleInstance(learningRules,RulePtr(new SingleRule<Chair,chairBase_chairBackRest>()));
	...
	appendRuleInstance(learningRules,RulePtr(new SingleRule<Chair,chairBase_chairBackRest_chairArmRest>()));
	...
	appendRuleInstance(learningRules,RulePtr(new SingleRule<Chair,chairBase_chairBackRest_chairBack>()));
	...
	appendRuleInstance(learningRules,RulePtr(new SingleRule<Chair,chairRArmRest_chairLArmRest_chairBack>()));
	...
	appendRuleInstance(learningRules,RulePtr(new SingleRule<Table,tableTop_tableDrawer>()));
	...
	appendRuleInstance(learningRules,RulePtr(new SingleRule<Table,tableTop_tableDrawer_keyboardTray>()));
	...
	appendRuleInstance(learningRules,RulePtr(new SingleRule<Table,tableTop_tableDrawer_keyboardTray_tableBack>()));
	appendRuleInstance(learningRules,RulePtr(new DoubleRule<tableTop_tableDrawer_tableBack,tableTop_tableDrawer,tableBack>()));
	appendRuleInstance(learningRules,RulePtr(new SingleRule<Table,tableTop_tableDrawer_tableBack>()));
	appendRuleInstance(learningRules,RulePtr(new DoubleRule<tableTop_tableDrawer_tableLeg,tableTop_tableDrawer,tableLeg>()));
	appendRuleInstance(learningRules,RulePtr(new SingleRule<Table,tableTop_tableDrawer_tableLeg>()));
	...
	appendRuleInstance(learningRules,RulePtr(new SingleRule<Table,tableTop_tableDrawer_tableLeg_keyboardTray>()));
	...
	appendRuleInstance(learningRules,RulePtr(new SingleRule<Table,tableTop_tableDrawer_tableLeg_keyboardTray_tableBack>()));
	...
	appendRuleInstance(learningRules,RulePtr(new SingleRule<Table,tableTop_tableDrawer_tableLeg_tableBack>()));
	...
	appendRuleInstance(learningRules,RulePtr(new SingleRule<Table,tableTop_tableDrawer_tableLeg_tableLeg>()));
	temp.clear();
	temp.push_back(typeid(printer).name());
	...
	appendRuleInstance(learningRules,RulePtr(new SingleRule<printer,printerSide_printerFront>()));
