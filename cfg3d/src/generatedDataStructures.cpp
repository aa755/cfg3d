...
vector<string> temp;
	...
	appendRuleInstance(learningRules,RulePtr(new SingleRule<Chair,chairBack_chairLArmRest>()));
	...
	appendRuleInstance(learningRules,RulePtr(new SingleRule<Fridge,FridgeDoor_FridgeSide>()));
	...
	appendRuleInstance(learningRules,RulePtr(new SingleRule<Table,keyboardTray_tableBack>()));
