...
vector<string> temp;
	...
	appendRuleInstance(learningRules,RulePtr(new DoubleRule<chairArmRest_chairBack_chairArmRest,chairArmRest_chairBack,chairArmRest>()));
	...
	temp.push_back(typeid(SupportComplex<CPU>).name());
	temp.push_back(typeid(CPU).name());
	appendRuleInstance(learningRules,RulePtr(new DoubleRuleComplex<Table,tableTop>(temp)));
