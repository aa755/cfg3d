...
//	appendRuleInstance(learningRules,RulePtr(new SingleRuleNoFeature<pillar,pillarMid>()));
...
//	appendRuleInstance(learningRules,RulePtr(new SingleRuleNoFeature<dustbin,dustbinWide>()));
...
//	appendRuleInstance(learningRules,RulePtr(new SingleRuleNoFeature<cupboard,cupboardSide_cupboardFront>()));
//	appendRuleInstance(learningRules,RulePtr(new DoubleRule<dustbinNarrow_dustbinWide,dustbinNarrow,dustbinWide>()));
//	appendRuleInstance(learningRules,RulePtr(new SingleRuleNoFeature<dustbin,dustbinNarrow_dustbinWide>()));
//	appendRuleInstance(learningRules,RulePtr(new DoubleRule<pillarRight_pillarLeft,pillarRight,pillarLeft>()));
//	appendRuleInstance(learningRules,RulePtr(new SingleRuleNoFeature<pillar,pillarRight_pillarLeft>()));
...
//	appendRuleInstance(learningRules,RulePtr(new SingleRuleNoFeature<pillar,pillarRight_pillarLeft_pillarMid>()));
...
//	appendRuleInstance(learningRules,RulePtr(new SingleRuleNoFeature<sofa,sofaBackRest_sofaBase_sofaArm>()));
